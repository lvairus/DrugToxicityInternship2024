...
# hyperparameters
task_name_list = ['bird', 'cat', 'chicken', 'dog', 'duck', 'gpig', 'mammal', 'man', 'mouse', 'quail', 'rabbit', 'rat', 'woman'] # whole (except 'human')
# task_name_list = ['bird', 'cat', 'chicken', 'dog', 'duck', 'gpig', 'mammal', 'man', 'quail', 'rabbit', 'woman'] # selection 
...
sweep_config = {
    ...
    'parameters': { 'seed_idx': {'values': list(range(10))},
                    'task1': {'values': task_name_list},
                    'task2': {'values': task_name_list},
